...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Jun-2025 às 13:51
...
CREATE TABLE `agencias` (
  ...
  `CPF_FUNCIONARIO` bigint(16) DEFAULT NULL
...
INSERT INTO `agencias` (`ID_AGENCIA`, `NOME`, `DATA_FUNDACAO`, `ENDERECO`, `EMAIL`, `NUMERO_FUNCIONARIOS`, `CPF_FUNCIONARIO`) VALUES
(1, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 123546),
(2, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 1202546),
(3, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 1215546),
(4, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 1223546),
(5, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 1224846),
(6, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 1228546),
(7, 'SAO PAULO', '2025-05-08', 'RUA BELA VISTA ', 'SAOPAULO@GMAIL', 5, 15223546);
...
CREATE TABLE `cartao` (
  ...
  `CVV` bigint(3) DEFAULT NULL,
  `SENHA` bigint(4) DEFAULT NULL,
...
INSERT INTO `cartao` (`NUMERO_CARTAO`, `NOME_RESPONSAVEL`, `DATA_VALIDADE`, `CVV`, `SENHA`, `ENDERECO_COBRANCA`, `BANDEIRA`) VALUES
(1234, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master'),
(1524, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master'),
(1584, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master'),
(4294, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master'),
(4534, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master'),
(5465, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master'),
(8434, 'joao', '25/03', 154, 4578, 'avenida sao joao ', 'master');
...
INSERT INTO `clientes` (`ID_CLIENTE`, `NOME`, `SOBRENOME`, `EMAIL`, `GENERO`, `NOME_EMPRESA`) VALUES
...
CREATE TABLE `conta` (
  `numero_conta` bigint(20) NOT NULL,
  `nome_titular` varchar(45) NOT NULL,
  `tipo_conta` text DEFAULT NULL,
  `data_abertura` date DEFAULT NULL,
  `limite_saque` text DEFAULT '150 reais',
...
INSERT INTO `conta` (`numero_conta`, `nome_titular`, `tipo_conta`, `data_abertura`, `limite_saque`, `id_Cliente`) VALUES
(1, 'joao', 'corente', NULL, ' ', 1),
(2, 'joao', 'corente', NULL, ' ', 2),
(3, 'joao', 'corente', NULL, ' ', 3),
(4, 'joao', 'corente', NULL, ' ', 4),
(5, 'joao', 'corente', NULL, ' ', 5),
(6, 'joao', 'corente', NULL, ' ', 6),
(7, 'joao', 'corente', NULL, ' ', 7);
...
INSERT INTO `funcionarios` (`CPF`, `NOME`, `DATA_NASCIMENTO`, `ENDERECO`, `EMAIL`, `GENERO`, `SALARIO`) VALUES
(123546, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(1202546, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(1215546, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(1223546, 'STHEFANI', '2001-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(1224846, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(1227546, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(1228546, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800),
(15223546, 'STHEFANI', '2002-05-01', 'RUA SAO JOSE', 'THEFA@GMAIL.COM', ' FEMININO', 1800);
...
CREATE TABLE `movimentacoes` (
  ...
  `numero_comprovante` bigint(50) DEFAULT NULL,
  `historicoMovimentacoes` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `pedidos` (
  `NUMERO_PEDIDO` bigint(100) NOT NULL,
  `numeroCartao` bigint(20) DEFAULT NULL,
...
INSERT INTO `pedidos` (`NUMERO_PEDIDO`, `numeroCartao`, `idCliente`) VALUES
(215, 1234, 1),
(225, 1524, 2),
(235, 1584, 3),
(255, 4534, 5),
...
CREATE TABLE `setor` (
  ...
  `ATIVIDADES_SETOR` text DEFAULT NULL,
  `cpfFuncionario` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `setor` (`ID_SETOR`, `RESPONSAVEL`, `METAS`, `NUMERO_FUNCIONARIOS`, `NOME`, `ATIVIDADES_SETOR`, `cpfFuncionario`) VALUES
(1, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 123546),
(2, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 1202546),
(3, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 1215546),
(4, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 1223546),
(5, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 1224846),
(6, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 1228546),
(7, 'ANA', 'VARIAS ', 10, 'RECEPCAO', 'RECEPICIONAR', 15223546);

-- --------------------------------------------------------

--
-- Estrutura da tabela `turno_funcionarios`
--

CREATE TABLE `turno_funcionarios` (
  `ID_TURNO` int(11) NOT NULL,
  `RESPONSAVEL` varchar(45) DEFAULT NULL,
  `HORARAIO_INICIO` time DEFAULT NULL,
  `HORARIO_FIM` time DEFAULT NULL,
  `NUMERO_FUNCIONARIOS` int(11) DEFAULT NULL,
  `cpf_funcionario` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Índices para tabela `turno_funcionarios`
--
ALTER TABLE `turno_funcionarios`
...
--
-- AUTO_INCREMENT de tabela `turno_funcionarios`
--
ALTER TABLE `turno_funcionarios`
...
--
ALTER TABLE `agencias`
  ADD CONSTRAINT `agencias_ibfk_1` FOREIGN KEY (`CPF_FUNCIONARIO`) REFERENCES `funcionarios` (`CPF`);

--
-- Limitadores para a tabela `conta`
--
ALTER TABLE `conta`
  ADD CONSTRAINT `conta_ibfk_1` FOREIGN KEY (`id_Cliente`) REFERENCES `clientes` (`ID_CLIENTE`);

--
-- Limitadores para a tabela `movimentacoes`
--
ALTER TABLE `movimentacoes`
  ADD CONSTRAINT `movimentacoes_ibfk_1` FOREIGN KEY (`idClientes`) REFERENCES `clientes` (`ID_CLIENTE`);

--
-- Limitadores para a tabela `pedidos`
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`ID_CLIENTE`),
  ADD CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`numeroCartao`) REFERENCES `cartao` (`NUMERO_CARTAO`);

--
-- Limitadores para a tabela `setor`
--
ALTER TABLE `setor`
  ADD CONSTRAINT `setor_ibfk_1` FOREIGN KEY (`cpfFuncionario`) REFERENCES `funcionarios` (`CPF`);

--
-- Limitadores para a tabela `turno_funcionarios`
--
ALTER TABLE `turno_funcionarios`
  ADD CONSTRAINT `turno_funcionarios_ibfk_1` FOREIGN KEY (`cpf_funcionario`) REFERENCES `funcionarios` (`CPF`);
COMMIT;
